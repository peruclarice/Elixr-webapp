				...
				<div class="row g-4 justify-content-center row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1">
						...
						<div class="about__item text-center">
							<div class="about__inner">
								<div class="about__thumb">
									<img src="assets/images/app/profile_charles.jpg" alt="dating thumb">
								</div>
								<div class="about__content">
									<h4>Charles</h4>
					...
					<div class="col wow fadeInUp" data-wow-duration="1.6s">
						<div class="about__item text-center">
							<div class="about__inner">
								...
								<div class="about__content">
									<h4>Adelle</h4>
									<p>"I love how easy it is to see events in my city, and even view events in other countries when I travel"</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col wow fadeInUp" data-wow-duration="1.7s">
						<div class="about__item text-center">
							<div class="about__inner">
								<div class="about__thumb">
									<img src="image/app/profile_clarissa" alt="dating thumb">
								</div>
								<div class="about__content">
									<h4>Mrs. Clarissa</h4>
					...
					<div class="col wow fadeInUp" data-wow-duration="1.8s">
						<div class="about__item text-center">
							<div class="about__inner">
								<div class="about__thumb">
									<img src="assets/image/app/profile_jeremy.jpg" alt="dating thumb">
								</div>
								<div class="about__content">
									<h4>Kwame</h4>
		...
		<div class="footer__bottom wow fadeInUp" data-wow-duration="1.5s">
			<div class="container">
				<div class="footer__content text-center">
					<p class="mb-0">All Rights Reserved &copy; <a href="index.html">Elixr</a> || Design By: CodexCoder</p>
				</div>
			</div>
		</div>
	</footer>
