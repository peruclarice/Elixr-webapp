...
<div class="banner banner--style2 padding-top bg_img" style =" padding-top: 80px;">
						...
						<div class="about__left">
							<div class="about__top">
								<div class="about__content">
									<h3 style ="color: var(--text-black);">Welcome To Our Elixr</h3>
							...
							<div class="about__bottom">
								<div class="about__bottom--head">
									<h5 style ="color: var(--text-black);">Latest Registered Members</h5>
	...
	<div class="about padding-top padding-bottom bg_img" style="background: var(--dark-bg-gradient);">
		<div class="container">
			<div class="section__header style-2 text-center wow fadeInUp" data-wow-duration="1.5s">
				<h2 class ="primary-color">Why Choose Elixr</h2>
	...
	<div class="work work--style2 padding-top padding-bottom bg_img" style="background: var(--dark-bg-gradient);">
		<div class="container">
			<div class="section__wrapper">
